...
def plot_confusion_matrix(args, client_id, cm, classes, epoch ,normalize=True, title='', cmap=plt.cm.Blues):
   ...
   base_name = f"/home/{os.getenv('USER')}/Federated-Learning-Biases/evaluation/{args.federated_type}/{args.dataset}/train_matrix"
...
def update_csv(args, client_idx, test_loss, test_acc, avg_grad_norm):
    ...
    filename = f"/home/{os.getenv('USER')}/Federated-Learning-Biases/evaluation/{args.federated_type}/{args.dataset}/client_train{client_idx}.csv"
